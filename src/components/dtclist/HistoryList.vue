<template>
  <section class="dtc-main-section">
    <header class="ask-header">歷年役男清冊</header>
    <div class="dtc-search">
      <main class="left-header">
        <b-input-group prepend="年度">
          <b-select :options="years" v-model="year" @change="searchDb"></b-select>
        </b-input-group>
        <b-input-group prepend="行政區">
          <b-select :options="areas" v-model="area" @change="searchDb"></b-select>
        </b-input-group>
        <b-input-group prepend="判定體位">
          <b-select :options="sizes" v-model="size" @change="searchDb"></b-select>
        </b-input-group>
        <b-input-group prepend="起始日期">
          <b-input type="date"></b-input>
        </b-input-group>

        <b-input-group prepend="梯次">
          <b-select :options="years" v-model="year" @change="searchDb"></b-select>
        </b-input-group>
        ...
        <b-input-group prepend="終止日期">
          <b-input type="date"></b-input>
        </b-input-group>
      </main>
      <div></div>
      <main class="right-header">
        <b-button class="mb-2" variant="light" @click="searchDb" size="sm">
